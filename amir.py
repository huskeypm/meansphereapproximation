...
def validation1(): 
  ...
  conc_M[idxCa] = cacl2
  hydrationEnergies= np.array([0.0001,122.7,142.0,419.2,513.3]) # multiplied by .0291 below because of Born scaling; see Gilespie 2012. Filter and bath eps are 25.0 and 78.4...
  hydrationEnergies= np.array([0.0001,122.7,142.0,419.2]) # multiplied by .0291 below because of Born scaling; see Gilespie 2012. Filter and bath eps are 25.0 and 78.4...

   
  chemPotential,donnanPotential,muES,muHS,rhoFilter = msa.SolveMSAEquations(
    epsilonFilter,conc_M,zs,Ns,V_i,sigmas,hydrationEnergies=hydrationEnergies) 
